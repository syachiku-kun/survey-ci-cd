...
$OsVersion = "2019"
$VmPurpose = "GitLab Runner on Windows"
$VmName = "${OsName} ${OsVersion}(${VmPurpose})"
$VmMemoryStartupGigaBytes = 4
$IsoPath = "C:\Users\whoami\Desktop\system\os\windows-server-2019\ja-jp\17763.3650.221105-1748.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_ja-jp.iso"
